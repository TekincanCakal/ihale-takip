namespace FaturaTakip.Controllers
{
    ...
    public class ElectricityTenderReportController : Controller
    {
        ...
        string _controllerName = "ElectricityTenderReport";

        public ElectricityTenderReportController(ElectricitySubscriberData electricitySubscriberData, ElectricityUnitPriceData electricityUnitPriceData, ElectricityBillData electricityBillData, ElectricityRateData rateData, UserManager userManager)
        {
        ...
        public ActionResult Index()
        {
            try
            {
                ...
                return View($"~/Views/{_service}/{_controllerName}/Index.cshtml");
            }
            catch (Exception ex)
            {
        ...
        public ActionResult CreateTenderReport(int tenderLimit, int startYear, int startMonth, int endYear, int endMonth)
        {
            try
            {
                ...
                return View($"~/Views/{_service}/{_controllerName}/CreateTenderReport.cshtml");
            }
            catch (Exception ex)
            {
                return RedirectToAction("Index", "Eror", new { errorMessage = ex.Message });
