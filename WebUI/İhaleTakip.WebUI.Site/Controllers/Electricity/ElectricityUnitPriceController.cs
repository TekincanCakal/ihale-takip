namespace FaturaTakip.Controllers
{
    ...
    public class ElectricityUnitPriceController : Controller
    {
        ...
        public ElectricityUnitPriceController(ElectricityUnitPriceData electricityUnitPriceData, ElectricitySubscriptionTypeData electricitySubscriptionTypeData, ElectricityRateData rateData)
        {
